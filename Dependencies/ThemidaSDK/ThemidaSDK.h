...
#define REMOVE_BLOCK_START                                                                                             \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define REMOVE_BLOCK_END                                                                                               \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
...
#define REGISTERED_START                                                                                               \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define REGISTERED_END                                                                                                 \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define ENCODE_START                                                                                                   \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x04, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define ENCODE_END                                                                                                     \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define CLEAR_START                                                                                                    \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define CLEAR_END                                                                                                      \
    __emit__(0xEB, 0x15, 0x57, 0x4C, 0x20, 0x20, 0x07, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20, 0x00, 0x00, 0x00, 0x00, 0x00);

#define UNREGISTERED_START                                                                                             \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define UNREGISTERED_END                                                                                               \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x09, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define VM_START                                                                                                       \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x0C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define VM_END                                                                                                         \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x0D, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define MUTATE_START                                                                                                   \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define MUTATE_END                                                                                                     \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define STR_ENCRYPT_START                                                                                              \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x12, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define STR_ENCRYPT_END                                                                                                \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x13, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define STR_ENCRYPTW_START                                                                                             \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x22, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define STR_ENCRYPTW_END                                                                                               \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x23, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);

#define REGISTEREDVM_START                                                                                             \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x0E, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define REGISTEREDVM_END                                                                                               \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x0F, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
...
#define UNPROTECTED_START                                                                                              \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x20, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
#define UNPROTECTED_END                                                                                                \
    __emit__(0xEB, 0x10, 0x57, 0x4C, 0x20, 0x20, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x57, 0x4C, 0x20,     \
             0x20);
...
#define CHECK_PROTECTION(var, val)                                                                                                                                                                                                                                                                                                             \
    __asm _emit 0xEB __asm _emit 0x10 __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91 __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x00 __asm _emit 0x00 __asm _emit 0x00 __asm _emit 0x00 __asm push val __asm pop \
            var __asm _emit 0xEB __asm _emit 0x0C __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91

#define CHECK_CODE_INTEGRITY(var, val)                                                                                                                                                                                                                                                                                                         \
    __asm _emit 0xEB __asm _emit 0x10 __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91 __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x01 __asm _emit 0x00 __asm _emit 0x00 __asm _emit 0x00 __asm push val __asm pop \
            var __asm _emit 0xEB __asm _emit 0x0C __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91

#define CHECK_REGISTRATION(var, val)                                                                                                                                                                                                                                                                                                           \
    __asm _emit 0xEB __asm _emit 0x10 __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91 __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x02 __asm _emit 0x00 __asm _emit 0x00 __asm _emit 0x00 __asm push val __asm pop \
            var __asm _emit 0xEB __asm _emit 0x0C __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91

#define CHECK_VIRTUAL_PC(var, val)                                                                                                                                                                                                                                                                                                             \
    __asm _emit 0xEB __asm _emit 0x10 __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91 __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x03 __asm _emit 0x00 __asm _emit 0x00 __asm _emit 0x00 __asm push val __asm pop \
            var __asm _emit 0xEB __asm _emit 0x0C __asm _emit 0xBD __asm _emit 0x7A __asm _emit 0x11 __asm _emit 0xBC __asm _emit 0x7A __asm _emit 0x71 __asm _emit 0x8B __asm _emit 0x8A __asm _emit 0x67 __asm _emit 0x31 __asm _emit 0xAB __asm _emit 0x91
